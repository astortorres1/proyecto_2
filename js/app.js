document.addEventListener('DOMContentLoaded', function () {
  ...
  function calcularInteres() {
    ...
    // Guardar datos en el servidor utilizando Axios (asíncrono)
    guardarDatosEnServidor(principal, tasa, periodos);
  }
  ...
  function guardarDatosEnServidor(principal, tasa, periodos) {
    // Hacer una petición POST al servidor con los datos utilizando Axios
    //  Servidor fictisio para que en el caso de tener uno, se guarde todo ahí
    axios.post('https://tu-servidor.com/guardar-datos', {
      principal: principal,
      tasa: tasa,
      periodos: periodos
    })
